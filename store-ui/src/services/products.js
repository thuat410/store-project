...
const mockProducts = [
  ...
  { id: 3, name: 'Baby Spinach', category: 'vegetables', price: 2.99, originalPrice: 3.99, discount: 25, rating: 4.7, reviews: 210, image: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=300', brand: 'GreenGarden', stock: 30, isOrganic: true, unit: '200g', isFlashDeal: true, isFeatured: true, description: 'Tender baby spinach leaves, washed and ready to use. Rich in iron and vitamins for a healthy lifestyle.' },
  { id: 4, name: 'Whole Milk', category: 'dairy', price: 3.29, originalPrice: 3.29, discount: 0, rating: 4.4, reviews: 156, image: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=300', brand: 'DairyPure', stock: 100, unit: '1L', isFeatured: true, description: 'Fresh whole milk from grass-fed cows. Rich and creamy, perfect for cereal, coffee, or drinking straight.' },
  { id: 5, name: 'Sourdough Bread', category: 'bakery', price: 4.99, originalPrice: 5.99, discount: 17, rating: 4.8, reviews: 342, image: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=300', brand: 'ArtisanBake', stock: 20, unit: 'loaf', isFlashDeal: true, isFeatured: true, description: 'Handcrafted sourdough bread with a crispy crust and chewy interior. Made using traditional fermentation for superior flavor.' },
  { id: 6, name: 'Orange Juice', category: 'beverages', price: 4.49, originalPrice: 5.49, discount: 18, rating: 4.2, reviews: 89, image: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=300', brand: 'SunFresh', stock: 60, unit: '1L', isFeatured: true, description: 'Freshly squeezed 100% pure orange juice with no added sugars or preservatives. Packed with vitamin C.' },
  { id: 7, name: 'Free Range Eggs', category: 'dairy', price: 5.99, originalPrice: 6.49, discount: 8, rating: 4.9, reviews: 456, image: 'https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?w=300', brand: 'HappyHen', stock: 45, unit: '12 pack', isFeatured: true, description: 'Premium free range eggs from hens raised on open pastures. Rich in protein and omega-3 fatty acids.' },
  { id: 8, name: 'Broccoli', category: 'vegetables', price: 1.49, originalPrice: 1.99, discount: 25, rating: 4.1, reviews: 67, image: 'https://images.unsplash.com/photo-1459411621453-7b03977f4bfc?w=300', brand: 'GreenGarden', stock: 55, unit: 'head', isFlashDeal: true, description: 'Fresh broccoli crowns, vibrant green and packed with nutrients. Great for steaming, roasting, or adding to stir-fries.' },
  { id: 9, name: 'Greek Yogurt', category: 'dairy', price: 3.79, originalPrice: 4.29, discount: 12, rating: 4.6, reviews: 198, image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=300', brand: 'DairyPure', stock: 35, unit: '500g', isFeatured: true, description: 'Thick and creamy Greek yogurt with a tangy flavor. High in protein and probiotics for digestive health.' },
  { id: 10, name: 'Strawberries', category: 'fruits', price: 4.99, originalPrice: 5.99, discount: 17, rating: 4.8, reviews: 287, image: 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=300', brand: 'BerryBest', stock: 25, isOrganic: true, unit: '400g', isFlashDeal: true, description: 'Sweet and juicy organic strawberries at peak ripeness. Perfect for desserts, smoothies, or eating fresh.' },
  { id: 11, name: 'Chicken Breast', category: 'meat', price: 8.99, originalPrice: 10.99, discount: 18, rating: 4.5, reviews: 176, image: 'https://images.unsplash.com/photo-1604503468506-a8da13d11d36?w=300', brand: 'FarmFresh', stock: 40, unit: '500g', isFlashDeal: true, description: 'Boneless, skinless chicken breasts from free-range chickens. Lean protein source perfect for healthy meals.' },
  { id: 12, name: 'Sparkling Water', category: 'beverages', price: 1.29, originalPrice: 1.29, discount: 0, rating: 4.3, reviews: 112, image: 'https://images.unsplash.com/photo-1559839914-17aae19cec71?w=300', brand: 'AquaFizz', stock: 200, unit: '500ml', description: 'Refreshing sparkling mineral water with natural carbonation. Crisp and clean taste, zero calories.' },
  { id: 13, name: 'Cheddar Cheese', category: 'dairy', price: 5.49, originalPrice: 6.49, discount: 15, rating: 4.7, reviews: 234, image: 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=300', brand: 'CheeseHouse', stock: 30, unit: '300g', description: 'Aged cheddar cheese with a sharp, complex flavor. Made from high-quality milk for premium taste.' },
  { id: 14, name: 'Blueberries', category: 'fruits', price: 3.99, originalPrice: 4.99, discount: 20, rating: 4.9, reviews: 321, image: 'https://images.unsplash.com/photo-1498557850523-fd3d118b962e?w=300', brand: 'BerryBest', stock: 40, isOrganic: true, unit: '250g', isFeatured: true, description: 'Plump and sweet organic blueberries, bursting with antioxidants. A superfood for your daily diet.' },
  { id: 15, name: 'Brown Rice', category: 'grains', price: 3.49, originalPrice: 3.99, discount: 13, rating: 4.4, reviews: 143, image: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=300', brand: 'WholeGrain', stock: 80, unit: '1kg', description: 'Whole grain brown rice with a nutty flavor and chewy texture. High in fiber and essential minerals.' },
  { id: 16, name: 'Cherry Tomatoes', category: 'vegetables', price: 2.49, originalPrice: 2.99, discount: 17, rating: 4.6, reviews: 189, image: 'https://images.unsplash.com/photo-1546094096-0df4bcaaa337?w=300', brand: 'GreenGarden', stock: 60, isOrganic: true, unit: '300g', isFeatured: true, description: 'Sweet and tangy organic cherry tomatoes, perfect for salads, snacking, or roasting.' },
  { id: 17, name: 'Almond Milk', category: 'beverages', price: 3.99, originalPrice: 4.49, discount: 11, rating: 4.5, reviews: 267, image: 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=300', brand: 'NutriBlend', stock: 50, unit: '1L', description: 'Creamy, unsweetened almond milk. A delicious dairy-free alternative rich in vitamin E and calcium.' },
  { id: 18, name: 'Croissants', category: 'bakery', price: 3.99, originalPrice: 4.99, discount: 20, rating: 4.7, reviews: 198, image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=300', brand: 'ArtisanBake', stock: 15, unit: '4 pack', isFeatured: true, description: 'Buttery, flaky croissants baked fresh daily. Made with premium European-style butter for exceptional flavor.' },
  { id: 19, name: 'Avocados', category: 'fruits', price: 1.79, originalPrice: 2.29, discount: 22, rating: 4.4, reviews: 145, image: 'https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=300', brand: 'TropicFresh', stock: 35, isOrganic: true, unit: 'each', isFlashDeal: true, description: 'Perfectly ripe organic avocados with creamy texture. Rich in healthy fats and essential nutrients.' },
  { id: 20, name: 'Mixed Nuts', category: 'snacks', price: 7.99, originalPrice: 9.99, discount: 20, rating: 4.8, reviews: 312, image: 'https://images.unsplash.com/photo-1604514628550-37477afdf4e3?w=300', brand: 'NutHouse', stock: 70, unit: '500g', isFeatured: true, description: 'Premium blend of cashews, almonds, walnuts, and pecans. Lightly salted and roasted to perfection.' }
]
